...
% Program:  les.m
% 
% Summary:  Compute sample paths over time of LES model.  Populations grow logistically but are
%           subject to multiplicatively coupled brownian motion.  
% 
% Inputs
...
% 
% Outputs
%           popmat   : Array of paths; row = time; columns = trials; 
%           
% 
% Fixed parameters
...
function [popmat] = les(r,Kparams,sig, numtrials, Tmax, dt,lextinct)
